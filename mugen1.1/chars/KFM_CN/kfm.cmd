...
type = ChangeState
value = 3050
triggerall = var(59)<=1 && command = "破裂功夫升龙"
...
type = ChangeState
value = 3000
triggerall = var(59)<=1 && command = "三连功夫掌"
triggerall = power >= 1000
...
type = ChangeState
value = 1070
triggerall = var(59)<=1 && command = "疾风腿"
...
type = ChangeState
value = 1050
triggerall = var(59)<=1 && command = "轻腿"
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1060
triggerall = var(59)<=1 && command = "重腿"
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1020
triggerall = var(59)<=1 && command = "疾风功夫掌"
triggerall = power >= 330
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1000
triggerall = var(59)<=1 && command = "轻功夫掌"
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1010 
triggerall = var(59)<=1 && command = "重功夫掌"
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1120
triggerall = var(59)<=1 && command = "疾风升龙"
triggerall = power >= 330
trigger1 = var(1) ;在可以取消时 
...
type = ChangeState
value = 1100
triggerall = var(59)<=1 && command = "轻升龙"
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1110
triggerall = var(59)<=1 && command = "重升龙"
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1220
triggerall = var(59)<=1 && command = "疾风破"
triggerall = power >= 330
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1200
triggerall = var(59)<=1 && command = "轻破"
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1210
triggerall = var(59)<=1 && command = "重破"
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1300
triggerall = var(59)<=1 && command = "格挡"
triggerall = var(59)<=1 && command != "蓄下方向"
triggerall = statetype != A
trigger1 = ctrl
...
value = 1340
triggerall = var(59)<=1 && command = "格挡"
triggerall = var(59)<=1 && command != "蓄前方向"
triggerall = var(59)<=1 && command != "蓄下方向"
triggerall = statetype = A
trigger1 = ctrl
...
type = ChangeState
value = 1420
triggerall = var(59)<=1 && command = "疾风铁山靠"
triggerall = power >= 330
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1400 
triggerall = var(59)<=1 && command = "轻铁山靠"
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 1410
triggerall = var(59)<=1 && command = "重铁山靠"
trigger1 = var(1) ;在可以取消时
...
type = ChangeState
value = 800
triggerall = var(59)<=1 && command = "y"
triggerall = statetype = S
triggerall = ctrl
triggerall = stateno != 100
trigger1 = var(59)<=1 && command = "蓄上方向"
trigger1 = p2bodydist X < 3
trigger1 = (p2statetype = S) || (p2statetype = C)
trigger1 = p2movetype != H
trigger2 = var(59)<=1 && command = "蓄后方向"
...
type = ChangeState
value = 195
triggerall = var(59)<=1 && command = "start"
